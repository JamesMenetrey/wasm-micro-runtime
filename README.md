...
- **[file](./samples/file/README.md)**: Demonstrating the supported file interaction API of WASI. This sample can also demonstrates the SGX IPFS (Intel Protected File System), enabling an enclave to seal and unseal data at rest.
